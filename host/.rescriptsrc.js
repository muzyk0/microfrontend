...
const addPlugins = config => {
    config.plugins.unshift(
        new ModuleFederationPlugin({
            ...
            exposes: {},
            remotes: {
                app: "web@http://localhost:3002/remoteEntry.js", // app - Любой ключ,но его надо запомнить он нам еще понадобиться,microfront_react - Имя нашего модуля ,в нашем случае имя микрофнта в package.json,
